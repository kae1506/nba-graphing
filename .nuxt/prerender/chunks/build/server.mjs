...
import { getContext, executeAsync } from 'file:///Users/keshava/Documents/Code/JavaScript%20Projects/nba_web/nba_graphing/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/keshava/Documents/Code/JavaScript%20Projects/nba_web/nba_graphing/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/keshava/Documents/Code/JavaScript%20Projects/nba_web/nba_graphing/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/keshava/Documents/Code/JavaScript%20Projects/nba_web/nba_graphing/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/keshava/Documents/Code/JavaScript%20Projects/nba_web/nba_graphing/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/keshava/Documents/Code/JavaScript%20Projects/nba_web/nba_graphing/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/keshava/Documents/Code/JavaScript%20Projects/nba_web/nba_graphing/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-YALk4UDb.mjs')
  },
  {
    name: "example",
    path: "/example",
    component: () => import('./example-DkOx2A4N.mjs')
  }
];
...
const plugin_server_8gPZvj_ioDujdrQ7KE1YRLpzi8Zcb_Z7M3_x4c0bQV0 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
      ...
      ssrContext.event.res.end(
        JSON.stringify({
          ...
          state: {
            ...
            ...Object.fromEntries(keysToIgnore.map((k) => [k, void 0]))
          }
        })
      );
      return;
...
const plugins = [
  ...
  plugin_server_8gPZvj_ioDujdrQ7KE1YRLpzi8Zcb_Z7M3_x4c0bQV0,
  prerender_server_sqIxOBipVr4FbVMA9kqWL0wT8FPop6sKAXLVfifsJzk
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-BobY0NwG.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CMyJIebt.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dh2MMgoK.mjs'));
